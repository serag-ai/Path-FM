...
def main():
    ...
    data_train_path = os.path.join(main_path, "P1")
    external_datasets = {
    ...
    print(f"Training dataset (P1) classes: {len(train_full_dataset.classes)}")
    ...
    print(f"Train size (P1): {len(train_dataset)}")
    print(f"Val size (P1):   {len(val_dataset)}")
    ...
    for model_name, fm_model, feature_dim, model_type in model_configs:
        ...
        csv_path = "FM_cross_P1_results.csv"
